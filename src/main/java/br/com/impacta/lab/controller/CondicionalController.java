...
public class CondicionalController {
	...
	public ResponseEntity<String> simularValores(@RequestParam(name="idade") int idade) {
		 ...
		 *  
		 */
		//URL: //https://java-spring-atividade-03-sala-jocneto.jocneto.repl.//co/atividades/condicional?idade=20

    String retorno=null;
    if (idade>=18){retorno="Possui mais de 18 anos";}
    else {retorno="Possui menos de 18 anos";}
